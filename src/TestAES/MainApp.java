...
public class MainApp extends JFrame {
	...
	String originalText = "lethanhlong2311";
	/**
	 ...
	 */
	public MainApp() {
		setTitle("CSBM - BT4 AES");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 909, 229);
...
//		this.lblOriginalText = new JLabel("Original text:  "+ this.originalText);
//		this.lblOriginalText.setBounds(15, 110, 176, 14);
//		this.lblOriginalText.setForeground(Color.RED);
//		this.contentPane.add(this.lblOriginalText);
		...
		showText = new JLabel(this.originalText) ;
	    this.showText.setBounds(93, 110, 106, 14);
		this.showText.setForeground(Color.RED);
		this.contentPane.add(this.showText);
...
//		this.contentPane.add(this.textAreaOriginal);
		...
		this.textAreaEncrypted.setBounds(337, 68, 200, 101);
		...
		this.textAreaDycrypted.setBounds(678, 68, 200, 101);
